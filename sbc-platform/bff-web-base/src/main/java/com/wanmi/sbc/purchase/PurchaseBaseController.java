...
//                    return Long.compare(su2, su);
    ...
    public BaseResponse addFollow(@RequestBody PurchaseAddFollowRequest queryRequest,HttpServletRequest request) {
        ...
        queryRequest.setBulkWareId(commonUtil.getBulkWareId(request));
     ...
     */
    @ApiOperation(value = "采购单商品移入收藏夹")
    @RequestMapping(value = "/newAddFollow", method = RequestMethod.PUT)
    public BaseResponse newAddFollow(@RequestBody PurchaseAddFollowRequest queryRequest,HttpServletRequest request) {
        Long wareId = commonUtil.getWareId(request);
        queryRequest.setCustomerId(commonUtil.getOperatorId());
        ...
        queryRequest.setWareId(wareId);
        queryRequest.setBulkWareId(commonUtil.getBulkWareId(request));
        purchaseProvider.newAddFollow(queryRequest);
        return BaseResponse.SUCCESSFUL();
    }
    ...
    @LcnTransaction
    public BaseResponse modifyGoodsMarketing(@PathVariable String goodsInfoId, @PathVariable Long marketingId, HttpServletRequest httpServletRequest) {
        ...
        purchaseModifyGoodsMarketingRequest.setWareId(wareId);
    ...
    @RequestMapping(value = "/checkPurchaseNum",method = RequestMethod.POST)
    public BaseResponse<CheckPurchaseNumResponse> checkPurchaseNum(@RequestBody CheckPurchaseNumRequest request){
        return purchaseQueryProvider.checkPurchaseNum(request);
    }
