...
@Api(tags = "GoodsAttributeController", description = "商品属性服务 API")
@RestController
...
public class GoodsAttributeController {
     ...
     * 修改商品属性
     *
     * @param pageRequest 商品属性 {@link GoodsAttributeAddRequest}
     * @return 商品属性
     */
    @ApiOperation(value = "修改商品属性")
    @RequestMapping(value = "/updateAttributeById", method = RequestMethod.POST)
    public BaseResponse<GoodsAttributeAddResponse> updateAttributeById(@RequestBody GoodsAttributeAddRequest pageRequest) {
        BaseResponse<GoodsAttributeAddResponse> pageResponse = goodsAttributeSaveProvider.updateAttribute(pageRequest);
        //操作日志记录
        operateLogMQUtil.convertAndSend("商品属性调用", "修改商品属性", "操作成功");
        return pageResponse;
    }
     ...
     * @return 商品属性
     */
    @ApiOperation(value = "修改商品属性（禁用启用）")
    @RequestMapping(value = "/updateStatus", method = RequestMethod.POST)
    public BaseResponse<GoodsAttributeAddResponse> updateStatus(@RequestBody GoodsAttributeAddRequest pageRequest) {
        BaseResponse<GoodsAttributeAddResponse> pageResponse = goodsAttributeSaveProvider.updateStatus(pageRequest);
        //操作日志记录
        operateLogMQUtil.convertAndSend("商品属性调用", "修改商品属性（禁用启用）", "操作成功:状态为" + pageResponse.getContext().getGoodsAttributeVo().getStatus());
        return pageResponse;
    }
    ...
    public BaseResponse<GoodsAttributeAddResponse> add(@RequestBody GoodsAttributeAddRequest pageRequest) {
        BaseResponse<GoodsAttributeAddResponse> pageResponse = goodsAttributeSaveProvider.add(pageRequest);
        //操作日志记录
        operateLogMQUtil.convertAndSend("商品属性调用", "添加商品属性", "操作成功");
        return pageResponse;
    }
    ...
    public BaseResponse<GoodsAttributeAddResponse> deleteById(@RequestBody GoodsAttributeAddRequest pageRequest) {
        BaseResponse<GoodsAttributeAddResponse> pageResponse = goodsAttributeSaveProvider.deleteById(pageRequest);
        //操作日志记录
        operateLogMQUtil.convertAndSend("商品属性调用", "删除商品属性", "操作成功");
        return pageResponse;
    }
