...
@Slf4j
@RestController
@RequestMapping(value = "/boss/bulk")
@Api(tags = "BossRetailGoodsInfoController",description = "Boss散批商品服务sku")
public class BossBulkGoodsInfoController {
    ...
    public BaseResponse<GoodsInfoViewPageResponse> skuList(@RequestBody GoodsInfoViewPageRequest queryRequest) {
        ...
        GoodsInfoViewPageResponse response = bulkGoodsInfoQueryProvider.pageView(queryRequest).getContext();
