...
@JobHandler(value="tradeMangoToMysqPilelHandler")
@Component
@Slf4j
public class TradeMangoToMysqPilelHandler extends IJobHandler {
    ...
    public ReturnT<String> execute(String param) throws Exception {
        ...
        tradeMangoToMysqlProvider.tradePileSaveToMysql(request);
        return SUCCESS;
    }
}
