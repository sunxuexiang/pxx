 ...
 */
@Api(tags = "StoreImageCateController", description = "店铺图片分类服务 API")
@RestController
public class StoreImageCateController {
     ...
     * 检测店铺图片分类是否有子类
     */
    @ApiOperation(value = "检测店铺图片分类是否有子类")
     ...
     * 检测店铺图片分类是否已关联图片
     */
    @ApiOperation(value = "检测店铺图片分类是否已关联图片")
