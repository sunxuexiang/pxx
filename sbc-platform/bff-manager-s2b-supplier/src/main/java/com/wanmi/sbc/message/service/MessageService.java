...
public class MessageService {
    ...
    public void addOrModifyTaskJob(MessageSendVO messageSendVO){
        if(Objects.nonNull(messageSendVO) &&
                (Objects.equals(MessageType.Preferential, messageSendVO.getMessageType()) || Objects.equals(MessageType.PUBLISH, messageSendVO.getMessageType()))){
    ...
    @Async
    public void deleteMessageByJoinId(Long messageId) {
        AppMessageDelByIdRequest request = new AppMessageDelByIdRequest();
        request.setJoinId(messageId);
        appMessageProvider.deleteByJoinId(request);
    }
}