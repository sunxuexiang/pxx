...
public class RedisCache {
     ...
     * @return
     */
    public List<String> randomMembers(String key,long var){
        return redisTemplate.opsForSet().randomMembers(key,var);
    }
     ...
     * @return
     */
    public Set<String> distinctRandomMembers(String key,long var){
        return redisTemplate.opsForSet().distinctRandomMembers(key,var);
    }
