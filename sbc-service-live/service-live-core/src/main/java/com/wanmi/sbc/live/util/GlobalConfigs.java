...
public class GlobalConfigs {
     ...
     * 数据库地址
     */
    private static final String DB_URL="jdbc:mysql://47.105.197.50:3306/sbc-live?useUnicode=true&useSSL=false&characterEncoding=utf8&useTimezone=true&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true&useServerPrepStmts=true&allowMultiQueries=true";
    /**
     * db 账号
     */
     ...
     * db 密码
     */
    private static final String PASSWORD = "Wmi@2019";
    /**
     * db 驱动
     */
     ...
     * 存放路径，包路径
     */
    private static final String PACKAGE = "com.wanmi.sbc.live.stream";
    /**
     * 需要生成的数据库表名，数组，可多个
     */
    private static final String[] TABLE_NAME = {"live_stream"};
