...
import com.wanmi.sbc.es.elastic.EsGoodsShelflife;
...
@Builder
@ApiModel
public class EsGoodsLimitBrandShelflifeResponse {
...
//    private Page<EsGoods> esGoods = new PageImpl<>(new ArrayList<>());
     ...
     * 包含保质期 索引sku
     */
    @ApiModelProperty(value = "包含保质期_索引SKU")
    private Page<EsGoodsShelflife> esGoods = new PageImpl<>(new ArrayList<>());
    ...
    /**
     * 散批爆款时刻-详情页banner图标地址
     */
    @ApiModelProperty(value = "散批爆款时刻-详情页banner图标地址")
