...
//@Document(indexName = EsConstants.INDEX_NAME, type = EsConstants.DOC_GOODS_TYPE )
@Data
public class EsGoods implements Serializable {
     ...
     * 虚拟排序
     */
    @ApiModelProperty(value = "虚拟排序")
    private Integer xnSort;
    /**
     * 商品副标题
     */
     ...
     * 商品副标题-new
     */
    @ApiModelProperty(value = "商品fu标题-new")
