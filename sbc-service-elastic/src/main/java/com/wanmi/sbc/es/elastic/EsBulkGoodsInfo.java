 ...
 */
@Document(indexName = EsConstants.DOC_BULK_GOODS_INFO_TYPE, type = EsConstants.DOC_BULK_GOODS_INFO_TYPE)
@Data
public class EsBulkGoodsInfo implements Serializable {

    private static final long serialVersionUID = 4834153388120667280L;
    @Id
    private String id;
     ...
     */
    @Field(type = FieldType.Nested)
    private List<GoodsAttributeKeyVO> GoodsAttributeSpu;
