...
@Data
@ApiModel
public class EsBulkGoodsInfoQueryRequest extends BaseQueryRequest {
    ...
    public SearchQuery getRetailSearchCriteria() {
        ...
        builder.withIndices(isQueryGoods ? EsConstants.DOC_BULK_GOODS_TYPE : EsConstants.DOC_BULK_GOODS_INFO_TYPE);
