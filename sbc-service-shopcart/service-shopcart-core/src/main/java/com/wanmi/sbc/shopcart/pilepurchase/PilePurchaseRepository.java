 ...
 */
@Repository
public interface PilePurchaseRepository extends JpaRepository<PilePurchase, Long>, JpaSpecificationExecutor<PilePurchase> {
     ...
     * @return
     */
    List<PilePurchase> queryPurchaseByCustomerIdAndInviteeId(String customerId, String inviteeId);
    ...
    List<PilePurchase> queryPurchaseByGoodsIdsAndCustomerId(@Param("goodsInfoIds") List<String> goodsInfoIds, @Param
    ...
    List<PilePurchase> queryPurchaseByGoodsInfoIdsAndCustomerId(@Param("goodsInfoIds") List<String> goodsInfoIds, @Param
