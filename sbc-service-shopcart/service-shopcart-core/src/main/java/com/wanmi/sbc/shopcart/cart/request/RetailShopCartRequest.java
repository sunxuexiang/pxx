package com.wanmi.sbc.shopcart.cart.request;

import com.wanmi.sbc.common.base.BaseQueryRequest;
import com.wanmi.sbc.customer.bean.vo.CustomerLevelVO;
import com.wanmi.sbc.goods.bean.dto.GoodsInfoDTO;
import com.wanmi.sbc.shopcart.bean.enums.FollowFlag;
import com.wanmi.sbc.shopcart.cart.RetailShopCart;
...
@AllArgsConstructor
@NoArgsConstructor
public class RetailShopCartRequest extends BaseQueryRequest {

    private static final long serialVersionUID = 7204479370273537619L;
    /**
     * 当前客户等级
     */
     ...
     * @return
     */
    public Specification<RetailShopCart> getWhereCriteria() {
