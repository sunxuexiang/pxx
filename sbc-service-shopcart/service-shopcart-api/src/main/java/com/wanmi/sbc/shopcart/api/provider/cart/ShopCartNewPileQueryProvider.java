 ...
 * Date: 2018-11-30
 */
@FeignClient(value = "${application.shopcart.name}", url="${feign.url.cart:#{null}}", contextId = "CartShopCartNewPileQueryProvider")
public interface ShopCartNewPileQueryProvider {
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/mini-list")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/list")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/query")
     ...
     * @return {@link PurchaseQueryResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/queryandcache")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-store-coupon-exist")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-store-marketing")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/query-goods-marketing-list")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-goods-marketing")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/count-goods")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/mini-list-front")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/list-front")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/validate-and-set-goods-marketings")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/distribution")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/purchase-info")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile-devanning/purchase-info")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile-devanning/purchase-cache-info")
    BaseResponse<MarketingGroupCardResponse> devanningPurchaseInfoCache(@RequestBody @Valid PurchaseListRequest request);




    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/check-purchas-num")
    ...
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/purchase-info-new")
    BaseResponse<PurchaseListResponse> newPurchaseInfo(@RequestBody @Valid PurchaseListNewRequest request);

    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-store-markeings")
    BaseResponse<PurchaseStoreMarketingResponse> getStoreMarketings(@RequestBody @Valid PurchaseStoreMarketingRequest request);

    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-devanning-store-markeings")
    ...
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/update-check-staues")
    ...
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-order-markeings")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-order-markeings-devanning")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/query-procurement-config")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/query-my-pile-purchase-list")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/pile-query")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/pile-query-by-customerId-and-skuId")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/get-pile-count-num-by-customerId")
     ...
     * @return {@link PurchaseCountGoodsResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/and/purchase/count-goods")
     ...
     * @return {@link PurchaseGetGoodsMarketingResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcartnewpile/query/suit-goods-by-purchase")
