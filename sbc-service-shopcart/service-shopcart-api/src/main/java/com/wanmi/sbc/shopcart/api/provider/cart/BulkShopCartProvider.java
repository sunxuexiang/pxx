 ...
 * Date: 2018-11-30
 */
@FeignClient(value = "${application.shopcart.name}", url="${feign.url.cart:#{null}}", contextId = "CartBulkShopCartProvider")
public interface BulkShopCartProvider {

    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/update-check-staues")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/newsave")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/new-datch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/update-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/update-devanning-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/update-devanning-numnew")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/delete")
    BaseResponse delete(@RequestBody @Valid PurchaseDeleteRequest request);
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/deleteByApi")
    BaseResponse delete(@RequestBody @Valid BulkShopCartApiRequest request);
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/devanningdelete")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/devanningdeleteCache")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/add-follow")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/clear-lose-goods")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/calc-amount")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/calc-marketing-by-marketing-id")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/calc-coupon-activity-by-activity-id")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/sync-goods-marketings")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/modify-goods-marketing")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/fill-buy-count")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/get-purchases-marketing")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/update-num-list")
    BaseResponse updateNumList(@RequestBody @Valid PurchaseUpdateNumRequest request);

    /**
     * 查询sku购物车里的数量
     */
    @PostMapping("/cart/${application.shopcart.version}/bulk/shopcart/get-sku-purchase-num")
