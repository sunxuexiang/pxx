 ...
 * Date: 2018-11-30
 */
@FeignClient(value = "${application.shopcart.name}", url="${feign.url.cart:#{null}}", contextId = "CartShopCartQueryProvider")
public interface ShopCartQueryProvider {
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/mini-list")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/list")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/query")
     ...
     * @return {@link PurchaseQueryResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/queryandcache")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-store-coupon-exist")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-store-marketing")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/query-goods-marketing-list")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-goods-marketing")
     ...
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/count-goods")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/mini-list-front")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/list-front")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/validate-and-set-goods-marketings")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/distribution")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/purchase-info")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart-devanning/purchase-info")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart-devanning/purchase-cache-info")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart-devanning/purchase-cache-mall-info")
    BaseResponse<MarketingGroupCartMallResponse> devanningPurchaseMallInfoCache(@RequestBody @Valid PurchaseListRequest request);




    @PostMapping("/cart/${application.shopcart.version}/shopcart/check-purchas-num")
    ...
    @PostMapping("/cart/${application.shopcart.version}/shopcart/purchase-info-new")
    BaseResponse<PurchaseListResponse> newPurchaseInfo(@RequestBody @Valid PurchaseListNewRequest request);

    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-store-markeings")
    BaseResponse<PurchaseStoreMarketingResponse> getStoreMarketings(@RequestBody @Valid PurchaseStoreMarketingRequest request);

    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-devanning-store-markeings")
    ...
    @PostMapping("/cart/${application.shopcart.version}/shopcart/update-check-staues")
    ...
    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-order-markeings")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-order-markeings-devanning")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/query-procurement-config")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/query-my-pile-purchase-list")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/pile-query")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/pile-query-by-customerId-and-skuId")
     ...
     * @return
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/get-pile-count-num-by-customerId")
     ...
     * @return {@link PurchaseCountGoodsResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/and/purchase/count-goods")
     ...
     * @return {@link PurchaseGetGoodsMarketingResponse}
     */
    @PostMapping("/cart/${application.shopcart.version}/shopcart/query/suit-goods-by-purchase")
