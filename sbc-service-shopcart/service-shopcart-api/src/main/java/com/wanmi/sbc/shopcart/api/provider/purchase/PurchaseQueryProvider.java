 ...
 * Date: 2018-11-30
 */
@FeignClient(value = "${application.shopcart.name}", url="${feign.url.order:#{null}}", contextId = "CartPurchaseQueryProvider")
public interface PurchaseQueryProvider {
     ...
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/mini-list")
     ...
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/list")
     ...
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/query")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/get-store-coupon-exist")
     ...
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/get-store-marketing")
     ...
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/query-goods-marketing-list")
     ...
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/get-goods-marketing")
     ...
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/count-goods")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/mini-list-front")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/list-front")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/validate-and-set-goods-marketings")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/distribution")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/purchase-info")
    BaseResponse<PurchaseListResponse> purchaseInfo(@RequestBody @Valid PurchaseListRequest request);

    @PostMapping("/order/${application.shopcart.version}/purchase/check-purchas-num")
    ...
    @PostMapping("/order/${application.shopcart.version}/purchase/purchase-info-new")
    BaseResponse<PurchaseListResponse> newPurchaseInfo(@RequestBody @Valid PurchaseListNewRequest request);

    @PostMapping("/order/${application.shopcart.version}/purchase/get-store-markeings")
    ...
    @PostMapping("/order/${application.shopcart.version}/purchase/get-order-markeings")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/query-procurement-config")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/query-my-pile-purchase-list")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/pile-query")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/pile-query-by-customerId-and-skuId")
     ...
     * @return
     */
    @PostMapping("/order/${application.shopcart.version}/purchase/get-pile-count-num-by-customerId")
