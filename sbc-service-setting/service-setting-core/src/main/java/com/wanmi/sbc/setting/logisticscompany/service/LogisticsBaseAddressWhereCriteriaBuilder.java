...
*/
public class LogisticsBaseAddressWhereCriteriaBuilder {
    public static Specification<LogisticsBaseAddress> build(LogisticsBaseAddressQueryRequest queryRequest) {
