...
/**
 * 视频教程资源资源分类表动态查询条件构建器
 * @author hudong
 * @date 2023-06-26 16:13:19
 */
public class VideoResourceCateWhereCriteriaBuilder {
    public static Specification<VideoResourceCate> build(VideoResourceCateQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            //类别
            if (queryRequest.getCateType() != null) {
                predicates.add(cbuild.equal(root.get("cateType"), queryRequest.getCateType()));
            }
