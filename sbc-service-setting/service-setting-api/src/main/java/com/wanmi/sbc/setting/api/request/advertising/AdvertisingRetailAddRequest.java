...
/**
 * @description: 新增散批广告位请求参数实体类
 * @author: XinJiang
 * @time: 2022/4/18 18:26
 */
@ApiModel
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AdvertisingRetailAddRequest implements Serializable {

    private static final long serialVersionUID = 5838889784809808760L;
