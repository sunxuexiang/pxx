...
/**
 * @description: 首页广告位修改请求类
 * @author: XinJiang
 * @time: 2022/2/18 10:43
 */
@ApiModel
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AdvertisingModifyRequest implements Serializable {

    private static final long serialVersionUID = -1671491443940602056L;
