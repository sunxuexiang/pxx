...
public class CompanyInfo implements Serializable {
    ...
    @OneToMany(cascade = {CascadeType.REFRESH, CascadeType.MERGE, CascadeType.REMOVE, CascadeType.PERSIST}, fetch = FetchType.EAGER, mappedBy = "companyInfo")
    private List<Store> storeList;

    //    @OneToMany(fetch = FetchType.LAZY)
//    @JoinColumn(name = "company_info_id", insertable = false, updatable = false)
//    @JsonIgnore
//    private List<CompanyMallReturnGoodsAddress> returnGoodsAddressList;
