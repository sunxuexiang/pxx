 ...
 */
public class StoreSimpleWhereCriteriaBuilder {
    public static Specification<StoreSimple> build(StoreQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            if (CollectionUtils.isNotEmpty(queryRequest.getNotEqCompanyTypes())) {
                predicates.add(cbuild.not(root.get("companyType").in(queryRequest.getNotEqCompanyTypes())));
            }
