...
public class RedisCache {
    ...
    public Set keys(String key){
        if (StringUtils.isEmpty(key)){
            Set keys = redisTemplate.keys(CacheKeyConstant.H_NETWORK_ADRESS_DISTANCE + "*");
            return keys;
        }
    ...
    public Long zrank (String key ,Object nkey){
        return redisTemplate.opsForZSet().reverseRank(key, nkey);
    }
