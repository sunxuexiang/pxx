package com.wanmi.sbc.customer.api.base;
...
@ApiModel
public class MicroServiceBasePage <T>  implements Page<T> {
    ...
    public MicroServiceBasePage() {
    }

    public MicroServiceBasePage(List<T> content) {
        this(content, null, null == content ? 0 : content.size());
    }

    public MicroServiceBasePage(Page page, Pageable pageable) {
        this(page.getContent(), pageable, page.getTotalElements());
    }

    public MicroServiceBasePage(List<T> content, Pageable pageable, long total) {
