...
public class CustomerGrowthValuePageRequest extends BaseQueryRequest implements Serializable {
    ...
    private static final long serialVersionUID = -1338718445632041262L;
     ...
     * 操作类型 0:扣除 1:增长
     */
    @ApiModelProperty(value = "操作类型 0:扣除 1:增长")
    private OperateType type;

    /**
     * 成长值获取业务类型、0签到 1注册 2分享商品 3分享注册 4分享购买  5评论商品 6晒单 7上传头像/完善个人信息 8绑定微信 9添加收货地址 10关注店铺 11订单完成
     */
    @ApiModelProperty(value = "成长值获取业务类型、0签到 1注册 2分享商品 3分享注册 4分享购买  5评论商品 6晒单 7上传头像/完善个人信息 8绑定微信 " +
