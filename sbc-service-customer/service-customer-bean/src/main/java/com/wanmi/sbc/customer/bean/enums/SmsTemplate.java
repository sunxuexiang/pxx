...
public enum SmsTemplate {
    ...
    @ApiEnumProperty("绑定银行卡验证码短信模板")
    CUSTOMER_BIND_BANK_CARD("您本次绑定银行卡的验证码是：%s，有效期5分钟，请勿泄露给他人。"),
    @ApiEnumProperty("注销账户验证码短信模板")
    LOG_CURRENT_USER_OFF("您本次注销账户的验证码是：%s，有效期5分钟，请勿泄露给他人。"),
    @ApiEnumProperty("商家注册大白鲸短信")
    CONTRACT_SIGN_IN("您已成功入驻大白鲸，地址：https://supplier.cjdbj.cn，账号：%1s 密码：%2s");
    ;
