...
public class LogUtil {
	...
	private final static Logger GATELOG = LoggerFactory.getLogger("ECNY_SDK_LOG");
	private final static Logger GATELOG_ERROR = LoggerFactory.getLogger("ECNY_SDK_ERR_LOG");
	private final static Logger GATELOG_MESSAGE = LoggerFactory.getLogger("ECNY_SDK_MSG_LOG");
