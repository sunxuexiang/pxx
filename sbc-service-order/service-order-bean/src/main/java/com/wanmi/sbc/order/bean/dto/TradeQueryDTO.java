...
public class TradeQueryDTO extends BaseQueryRequest {
    ...
    @ApiModelProperty(value = "店铺名称 模糊查询")
    ...
    @ApiModelProperty(value = "不匹配店铺编码 精确查询")
     ...
     * 白鲸管家名称查询
     */
    @ApiModelProperty(value = "白鲸管家姓名查询")
    private String managerName;

    /**
     * 白鲸管家名称查询
     */
    @ApiModelProperty(value = "白鲸管家账号查询")
     ...
     * 白鲸管家id集合
     */
    @ApiModelProperty(value = "白鲸管家id集合")
    ...
    @ApiModelProperty(value = "白鲸管家ID")
    private String managerId;

    @ApiModelProperty(value = "是否自有，1为自有")
     ...
     * 是否预售订单
     */
    @ApiModelProperty(value = "是否预售订单",dataType = "com.wanmi.sbc.common.enums.BoolFlag")
    ...
    private List<Criteria> getCommonCriteria() {
        ...
        if (StringUtils.isNotBlank(refundVoucherImagesFlag)) {
            if("1".equals(refundVoucherImagesFlag)) {
                criterias.add(Criteria.where("refundVoucherImagesFlag").is(refundVoucherImagesFlag));
            }else{
                criterias.add(Criteria.where("refundVoucherImagesFlag").ne("1"));
            }
        }
     ...
     * 大白鲸个人中心使用
     */
    public void makeAllAuditFlowStatusList() {
        tradeState.setPayState(PayState.PAID);
    }
