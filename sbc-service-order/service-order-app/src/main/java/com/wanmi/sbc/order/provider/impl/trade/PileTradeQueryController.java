...
import com.wanmi.sbc.order.trade.repository.PileStockRecordTradeItemRepository;
...
//        }
    ...
    public BaseResponse<CustomerPilePurchaseListResponse> getPilePurchaseByCustomerId(PilePurchaseRequest request) {
        com.wanmi.sbc.order.pilepurchase.request.PilePurchaseRequest purchaseRequest = KsBeanUtil.convert(request, com.wanmi.sbc.order.pilepurchase.request.PilePurchaseRequest.class);
