...
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "NewPileReturnOrderProvider")
public interface NewPileReturnOrderProvider {
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/get-refund-order-by-return-code-new-pile")
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/page")
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileRefund/get-by-return-order-no")
     ...
     * @return {@link RefundOrderResponse }
     */
    @PostMapping("/order/${application.order.version}/newPileRefund/get-pile-refund-order-resp-by-return-code")
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/get-by-id")
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/audit")
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/list-by-condition")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/offline-refund-for-boss")
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/add")
     ...
     */
    @PostMapping("/order/${application.order.version}/return/new-pile-list-by-tid")
     ...
     */
    @PostMapping("/order/${application.order.version}/return/new-pile-query-can-return-item-num-by-tid")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/newPileReturn/offlineRefundForSupplier")
    BaseResponse offlineRefundForSupplier(@RequestBody @Valid ReturnOrderOfflineRefundForSupplierRequest request);

    @PostMapping("/order/${application.order.version}/newPileTrade/doRefreshReturnedOrder")
    BaseResponse doRefreshReturnOrder(@RequestBody @Valid RefreshReturnedOrderRequest request);

    @PostMapping("/order/${application.order.version}/newPileReturn/refundOnlineByTid")
