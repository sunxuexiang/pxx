 ...
 */
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "HistoryLogisticsCompanyProvider")
public interface HistoryLogisticsCompanyProvider {
	 ...
	 */
	@PostMapping("/order/${application.order.version}/historylogisticscompany/add")
	 ...
	 */
	@PostMapping("/order/${application.order.version}/historylogisticscompany/modify")
	 ...
	 */
	@PostMapping("/order/${application.order.version}/historylogisticscompany/delete-by-id")
	 ...
	 * @return 删除结果 {@link BaseResponse}
	 */
	@PostMapping("/order/${application.order.version}/historylogisticscompany/delete-by-id-list")
