...
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "TradeGroupQueryProvider")
public interface TradeGroupQueryProvider {
     ...
     */
    @PostMapping("/order/${application.order.version}/trade/get-trade-group-by-group-ids")
