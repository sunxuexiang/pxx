 ...
 */
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "NewPileTradeItemQueryProvider")
public interface NewPileTradeItemQueryProvider {
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileTrade/item/list-by-customer-id")
     ...
     * @return 订单商品快照列表 {@link TradeItemByCustomerIdResponse}
     */
    @PostMapping("/order/${application.order.version}/newPileTrade/item/list-all-by-customer-id")
    BaseResponse<TradeItemByCustomerIdResponse> listAllByCustomerId(@RequestBody @Valid TradeItemByCustomerIdRequest
                                                                            request);

    @PostMapping("/order/${application.order.version}/newPileTrade/item/list-stock-out-storeId")
     ...
     * @return 订单商品快照列表 {@link TradeItemByCustomerIdResponse}
     */
    @PostMapping("/order/${application.order.version}/newPileTrade/item/item_list-by-customer-id")
     ...
     */
    @PostMapping("/order/${application.order.version}/newPileTrade/item/snapshot")
