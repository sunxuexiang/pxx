 ...
 */
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "ReturnOrderQueryProvider")
public interface ReturnOrderQueryProvider {
     ...
     * @return 退单分页列表 {@link ReturnOrderPageResponse}
     */
    @PostMapping("/order/${application.order.version}/return/newPage")
     ...
     * @return 可退金额 {@link ReturnOrderQueryRefundPriceResponse}
     */
    @PostMapping("/order/${application.order.version}/return/query-refund-price-new-pile")
     ...
     * @return 含可退商品的交易信息 {@link CanReturnItemNumByTidResponse}
     */
    @PostMapping("/order/${application.order.version}/devanning/return/query-can-return-item-num-by-tid")
     ...
     * @return 含可退商品的交易信息 {@link CanReturnItemNumByTidResponse}
     */
    @PostMapping("/order/${application.order.version}/return/query-can-return-num")
