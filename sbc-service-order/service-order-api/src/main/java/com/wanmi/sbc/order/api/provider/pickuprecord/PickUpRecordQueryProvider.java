...
import com.wanmi.sbc.order.api.request.pickuprecord.PickUpRecordPageRequest;
import com.wanmi.sbc.order.api.response.pickuprecord.PickUpRecordPageResponse;
import com.wanmi.sbc.order.api.request.pickuprecord.PickUpRecordListRequest;
import com.wanmi.sbc.order.api.response.pickuprecord.PickUpRecordListResponse;
import com.wanmi.sbc.order.api.request.pickuprecord.PickUpRecordByIdRequest;
 ...
 */
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "PickUpRecordQueryProvider")
public interface PickUpRecordQueryProvider {
	 ...
	 */
	@PostMapping("/order/${application.order.version}/pickuprecord/page")
	 ...
	 */
	@PostMapping("/order/${application.order.version}/pickuprecord/list")
	 ...
	 */
	@PostMapping("/order/${application.order.version}/pickuprecord/get-by-id")
	 ...
	 * @return 自提详情 {@link PickUpRecordByIdResponse}
	 */
	@PostMapping("/order/${application.order.version}/pickuprecord/get-by-trade-id")
