 ...
 */
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "ReturnPileOrderProvider")
public interface ReturnPileOrderProvider {
     ...
     */
    @PostMapping("/order/${application.order.version}/pile/return/add")
     ...
     */
    @PostMapping("/order/${application.order.version}/pile/return/add-transfer")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/delete-transfer")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/audit")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/deliver")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/receive")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/reject-receive")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/online-modify-price")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/online-refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/offline-refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/offline-refund-for-supplier")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/offline-refund-for-boss")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/reject-refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/reject-refund-refuse")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/cancel")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/reverse")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/remedy")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/modify-employee-id")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/fill-employee-id")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/modify")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/pile/return/close-refund")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/pile/return/refund-online-by-tid")
