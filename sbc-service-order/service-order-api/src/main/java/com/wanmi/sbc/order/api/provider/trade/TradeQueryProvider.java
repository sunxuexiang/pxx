 ...
 */
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "TradeQueryProvider")
...
//    BaseResponse<TradePageResponse> page(@RequestBody @Valid TradePageRequest tradePageRequest);
    ...
    @PostMapping("/order/${application.order.version}/trade/get-freight-delivery-store")
    ...
    @PostMapping("/order/${application.order.version}/trade/get-trade-freight-and-bluk")
     ...
     * @return 店铺运费信息 {@link TradeGetFreightResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/get-boss-freight")
     ...
     * @return 商品信息列表 {@link TradeGetGoodsResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/devanning/get-goods")
     ...
     * @return 商品信息列表 {@link TradeGetGoodsResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/get-retail-goods")
     ...
     * @return 商品信息列表 {@link TradeGetGoodsResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/get-bulk-goods")
     ...
     * 管理后台交易订单信息查询
     */
    @PostMapping("/order/${application.order.version}/trade/getByIdManager")
     ...
     * @return 交易单信息 {@link TradeGetByIdResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/get-by-parent")
     ...
     * @return 交易单确认项 {@link TradeQueryPurchaseInfoResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/query-take-purchaseInfo")
...
//     */
//    @PostMapping("/order/${application.order.version}/trade/count-by-flowState")
...
//     */
//    @PostMapping("/order/${application.order.version}/trade/count-by-payState")
//    BaseResponse<TradeCountByPayStateResponse> countByPayState(@RequestBody @Valid TradeCountByPayStateRequest tradeCountByPayStateRequest);
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/send-email-translate")
     ...
     * @return 验证结果 {@link TradeListExportResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/list-trade-expor-montht")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/query-all-comfirm-failed")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/get-order-list-by-logisticscompany-id")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/get-order-list-by-customer-id")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/get-order-list-by-customer-id-marketid")
    BaseResponse<Long> getByCustomerIdAndMarketId(@RequestBody @Valid TradeByCustomerIdRequest request);

    @PostMapping("/order/${application.order.version}/trade/get-History-Vo-list-by-customer-id-marketid")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/query-Purchase-Count")
    BaseResponse<Long> queryPurchaseCount(@RequestBody @Valid PurchaseQueryCountRequest request);

    /**
     * 近30天销量排行
     */
    @PostMapping("/order/${application.order.version}/trade/query-salesRanking")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/get-order-time-by-customer-id")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/logistics")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/getbyids")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/getbyidssimplify")
    BaseResponse<List<TradeVO>> getOrderByIdsSimplify(@RequestBody @Valid List<String> ids);

    @PostMapping("/order/${application.order.version}/trade/checkTrade")
    BaseResponse<TradeCheckResponse> checkTrade(@RequestBody @Valid TradeCheckRequest request);
    /**
     * 通过多条件查询有效的订单（聚合函数）
     *
     * */
    @PostMapping("/order/${application.order.version}/trade/recommendTypeByCustomerIdAndCompanyInfo")
     ...
     *
     * */
    @PostMapping("/order/${application.order.version}/trade/recommendTypeByCustomerId")
     ...
     *
     * */
    @PostMapping("/order/${application.order.version}/trade/recommendTypeGetCustomerId")
    BaseResponse<List<OrderRecommendCount>> recommendTypeGetCustomerId();

    /**
     * 近30天销量排行
     */
    @PostMapping("/order/${application.order.version}/trade/query-orderSort")
    BaseResponse<List<Object>> orderSort();
    /**
     *查询收款单状态
     *
     * */
    @PostMapping("/order/${application.order.version}/trade/queryKingdeePushPayStatus")
    BaseResponse<Integer> queryKingdeePushPayStatus(@RequestParam(value="tid")String tid);
    @PostMapping("/order/${application.order.version}/trade/recommendByUserIdAndSku")
    BaseResponse<List<OrderRecommendCount>> recommendByUserIdAndSku();
    @PostMapping("/order/${application.order.version}/trade/listAllbyCostmerId")
    BaseResponse<List<Object>> listAllbyCostmerId(@RequestBody @Valid TradeListAllRequest build);
    @PostMapping("/order/${application.order.version}/trade/sortByCustomerId")
    BaseResponse<List<OrderRecommendSkuCount>> sortByCustomerId(@RequestBody @Valid TradeListAllRequest build);

    @PostMapping("/order/${application.order.version}/trade/sortByUserIdAndSku")
    BaseResponse<List<OrderRecommendCount>> sortByUserIdAndSku();

    @GetMapping("/order/${application.order.version}/trade/findTradeVOById")
    BaseResponse<TradeVO> findTradeVOById(@RequestParam("id") String id);

    @GetMapping("/order/${application.order.version}/trade/findVillageAddDeliveryByTradeId")
    BaseResponse<BigDecimal> findVillageAddDeliveryByTradeId(@RequestParam("tradeId") String tradeId);

    @GetMapping("/order/${application.order.version}/trade/queryPrintOrderBillInfo")
    BaseResponse<TmsOrderBillNoDTO> queryPrintOrderBillInfo(@RequestParam("tradeId") String tradeId);
}
