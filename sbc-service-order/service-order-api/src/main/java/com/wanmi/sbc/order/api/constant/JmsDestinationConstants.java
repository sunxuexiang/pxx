...
public interface JmsDestinationConstants {
     ...
     * 处理退运费加收消息
     */
    String Q_ORDER_SERVICE_PUSH_REFUND_EXTRA_PRODUCER="delay-push-refund-extra-producer";
    String Q_ORDER_SERVICE_PUSH_REFUND_EXTRA_CONSUMER="delay-push-refund-extra-consumer";
