...
import com.wanmi.sbc.order.bean.dto.FreightTempDescQueryDTO;
import com.wanmi.sbc.order.bean.dto.MarketTradeInfoDTO;
import com.wanmi.sbc.order.bean.dto.TradeDeliverUpdateDTO;
import com.wanmi.sbc.order.bean.dto.TradePushLogisticRequestDTO;
 ...
 */
@FeignClient(value = "${application.order.name}", url="${feign.url.order:#{null}}", contextId = "TradeProvider")
public interface TradeProvider {
     ...
     */
    @PostMapping("/order/${application.order.version}/trade/query-delivery")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/change-item-price")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/devanningcommit")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/commit-all")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade1/commit-devanning-all")
    BaseResponse<TradeCommitResponse> devanningcommitAll(@RequestBody @Valid TradeCommitRequest tradeCommitRequest);

    @PostMapping("/order/${application.order.version}/trade/takeGoods")
    ...
    @PostMapping("/order/${application.order.version}/trade/pushLogisticsToThrid")
    BaseResponse<TradeDeliverResponse> pushLogisticsToThrid(@RequestBody TradePushLogisticRequestDTO pushLogisticRequestDTO);

    @PostMapping("/order/${application.order.version}/trade/thirdPartyDeliver")
    ...
    */
    @PostMapping("/order/${application.order.version}/trade/update-deliver")
     ...
     * @return 物流编号 {@link TradeDeliverResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/deliver2")
    ...
    @PostMapping("/order/${application.order.version}/trade/pay-callBack-take-goods-online-batch")
     ...
     * @return 支付结果 {@link TradeDefaultPayResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/pile-default-pay")
     ...
     * @return 支付单集合 {@link TradeConfirmPayOrderResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/confirm-payOrder-offline")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/order/${application.order.version}/trade/push-wms-Order")
    BaseResponse pushConfirmOrder(@RequestBody @Valid TradeGetByIdRequest tradeGetByIdRequest);


    @PostMapping("/order/${application.order.version}/trade/send-pick-up-message")
    BaseResponse sendPickUpMessage(@RequestBody @Valid SendPickUpMessageRequest sendPickUpMessageRequest);

    @PostMapping("/order/${application.order.version}/trade/updateTradeLogisticsCompany")
    ...
    @PostMapping("/order/${application.order.version}/trade/check-wms")
    ...
    @PostMapping("/order/${application.order.version}/trade/pay-online-recharge-call-back")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/pay-online-take-good-call-back")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/push-order-to-wms")
    ...
    */
    @PostMapping("/order/${application.order.version}/trade/push-order-to-tms")
     ...
     * @author shiy  2023/9/20 9:05
     */
    @PostMapping("/order/${application.order.version}/trade/cancel-order-to-tms")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/push-kingdee-compensation-order")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/add-merge-pay")
    BaseResponse addMergePay(@RequestBody @Valid TradeAddMergePayRequest request);


    @PostMapping("/order/${application.order.version}/trade/push-cache-push-kingdee-order")
    BaseResponse pushCachePushKingdeeOrder();

    @PostMapping("/order/${application.order.version}/trade/push-order-to-wms2")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/compensate-failed-sales-orders")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/stockup/delete-by-create-time")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/stockup/batch-add")
     ...
     */
    @PostMapping("/order/${application.order.version}/stockup/newConfirmPayOrderOffline")
     ...
     */
    @PostMapping("/order/${application.order.version}/ticketsForm/pushPayOrderKingdee")
     ...
     */
    @PostMapping("/order/${application.order.version}/balanceForm/pushPayOrderKingdee")
     ...
     * @param request
     */
    @PostMapping("/order/${application.order.version}/orderPicking/add")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/orderPicking/list")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/orderPicking/tid")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/pushRefundOrderKingdeeForCoin")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/pushOrderKingdeeForCoin")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/submit_mall_trades")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/trade-dilvery-area-template")
    ...
    */
    @GetMapping("/order/${application.order.version}/trade/initHistoryTradeInfo")
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/deliverPresell")
    BaseResponse deliverPresell(@RequestBody @Valid TradeDeliverRequest tradeDeliverRequest);
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/updatePresellDeliverDate")
    BaseResponse updatePresellDeliverDate(@RequestBody @Valid TradeDateUpdateRequest request);

    @PostMapping("/order/${application.order.version}/trade/checkSubmitTradeDeliveryToStore")
    BaseResponse checkSubmitTradeDeliveryToStore(@RequestBody MarketTradeInfoDTO marketTradeInfoDTO);

    @PostMapping("/order/${application.order.version}/trade/udpateEvaluateStatus")
    BaseResponse udpateEvaluateStatus(@RequestBody TradeEvaluateRequest request);
     ...
     * @return
     */
    @PostMapping("/order/${application.order.version}/trade/push-tradeAppendEventLog-to-tms")
    BaseResponse tradeAppendEventLog(@RequestBody @Valid TradeAppendEventLogRequest request);

    @GetMapping("/order/${application.order.version}/trade/delete")
    BaseResponse deleteByTradeId(@RequestParam(value="tradeId")String tradeId);

    @GetMapping("/order/${application.order.version}/trade/canReturnVillagePrice")
    BaseResponse<String> getCanReturnVillagePriceTrade(@RequestParam(value="tradeId")String tradeId);

    @PostMapping("/order/${application.order.version}/trade/getTmsFreightTempDesc")
    BaseResponse<String> getTmsFreightTempDesc(@RequestBody FreightTempDescQueryDTO queryDTO);
}
