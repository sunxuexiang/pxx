...
import com.wanmi.sbc.order.pilepurchase.PilePurchaseService;
...
import com.wanmi.sbc.order.trade.pilefsm.PileTradeFSMService;
...
import com.wanmi.sbc.order.util.EmailOrderUtil;
import com.wanmi.sbc.order.util.KingdeeLoginUtils;
import com.wanmi.sbc.order.util.TradeExportUtil;
...
//                });
    ...
    private void deletePurchaseOrder(String customerId, List<String> skuIds, DistributeChannel distributeChannel) {
        PurchaseApiRequest request = PurchaseApiRequest.builder()
