...
import com.wanmi.sbc.order.trade.model.root.TradePushPayOrderGroupon;
...
public class OrderProducerService {
    ...
    */
    ...
    public void pushRefundExtra(String sendStr, long millis) {
        resolver.resolveDestination(JmsDestinationConstants.Q_ORDER_SERVICE_PUSH_REFUND_EXTRA_PRODUCER).send(MessageBuilder.withPayload(sendStr).setHeader("x-delay", millis ).build());
    }
}
