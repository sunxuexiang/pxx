 ...
 */
@Repository
public interface PilePurchaseRepository extends JpaRepository<com.wanmi.sbc.order.pilepurchase.PilePurchase, Long>, JpaSpecificationExecutor<com.wanmi.sbc.order.pilepurchase.PilePurchase> {
     ...
     * @return
     */
    List<com.wanmi.sbc.order.pilepurchase.PilePurchase> queryPurchaseByCustomerIdAndInviteeId(String customerId, String inviteeId);
    ...
    List<com.wanmi.sbc.order.pilepurchase.PilePurchase> queryPurchaseByGoodsIdsAndCustomerId(@Param("goodsInfoIds") List<String> goodsInfoIds, @Param
    ...
    List<com.wanmi.sbc.order.pilepurchase.PilePurchase> queryPurchaseByGoodsInfoIdsAndCustomerId(@Param("goodsInfoIds") List<String> goodsInfoIds, @Param
