...
@Component
public class NewPileReturnRefundImpl extends AbstractRefund<NewPileTrade, NewPileReturnOrder> {
    @Override
    public Map<String, List<RefundByChannelRequest.RefundItem>> calcChannelRefundAmount(
            NewPileTrade trade,
            NewPileReturnOrder returnOrder
    ) {
