...
@AllArgsConstructor
@NoArgsConstructor
@Document(collection = "newPileReturnOrder")
public class NewPileReturnOrder implements Serializable {
    ...
    /**
     * 退单申请来源（0->囤货退款申请；1->提货退款申请）
     */
    private DefaultFlag applyChannl;
    ...
    //是否进入财务退款
    private Boolean financialRefundFlag;
}
