 ...
 */
@Component
public class AuditActionPile extends PileTradeAction {
     ...
     * @param trade
     */
    private void check(PileTrade trade, Operator operator) {
     ...
     * @param trade
     */
    private void reject(PileTrade trade, Operator operator) {
        TradeState tradeState = trade.getTradeState();
