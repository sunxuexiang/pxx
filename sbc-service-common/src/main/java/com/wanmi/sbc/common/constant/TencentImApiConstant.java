...
public class TencentImApiConstant {
    ...
    public static class AccountManage {
        ...
        /**加入个人资料注册*/
        public static final String PROFILE_PROFILE = "v4/profile/profile";
        /**拉取会话*/
        public static final String RECENTCONTACT_GET_LIST = "v4/recentcontact/get_list";
        /**查询用户资料*/
        public static final String PROFILE_PORTRAIT_GE = "v4/profile/portrait_ge";
        /**删除会话*/
        public static final String RECENTCONTACT_DELETE = "v4/recentcontact/delete";
        /**删除会话*/
        public static final String GET_C2C_UNREAD_MSG_NUM = "v4/openim/get_c2c_unread_msg_num";

        /**拉取历史信息*/
        public static final String OPEN_MSG_SVC_GET_HISTORY = "v4/open_msg_svc/get_history";

        /**单聊消息*/
        public static final String OPEN_IM_SEND_MSG = "v4/openim/sendmsg";
    ...
    public static class GroupManage {
        ...
        public static String MARK_CONTACT = "/v4/recentcontact/mark_contact";
    }
