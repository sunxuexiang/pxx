...
public class DevanningGoodsInfoVO implements Serializable {
     ...
     */
    @ApiModelProperty(value = "购买量")
    private BigDecimal bigBuyCount = BigDecimal.ZERO;
     ...
     * 单笔订单限购数量
     */
    @ApiModelProperty(value = "用户区域限购数量")
    private BigDecimal singleUserPurchaseNum;
    ...
    private List<DevanningGoodsInfoVO> giftList;
    ...
    private List<DevanningGoodsInfoVO> suitGoodsList;
     ...
     * 拆箱商品副标题
     */
    @ApiModelProperty(value = "拆箱商品副标题")
    private String goodsInfoSubtitle;

    /**
     * 拆箱商品副标题
     */
    @ApiModelProperty(value = "拆箱商品副标题_new")
    private String goodsSubtitleNew;

    /**
     * 根据有效商品排序
     */
    @ApiModelProperty(value = "v根据有效商品排序")
    ...
    @ApiModelProperty(value = "购物车是否存在当前拆箱商品")
    private Boolean isExit;

    /*--------------------------------------------------下面是辅助字段，不是DevanningGoodInfo本身的属性 -----------------------------------------------------------------------------------*/
    ...
    /**
     * 当前登录用户再当前营销活动下还能参与几件
     */
    @ApiModelProperty(value = "当前登录用户的营销活动限购量")
    ...
    private BoolFlag pileFlag;

    @ApiModelProperty(value = " 主sku）——0 否 1是")
    private Integer hostSku;

    /**
     * 是否可预售标记
     */
    @ApiModelProperty(value = "是否可预售标记")
