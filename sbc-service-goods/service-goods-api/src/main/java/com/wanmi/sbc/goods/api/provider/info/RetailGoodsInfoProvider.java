 ...
 * @Date: 2022/3/8 15:53
 */
@FeignClient(value = "${application.goods.name}", url="${feign.url.goods:#{null}}", contextId = "RetailGoodsInfoProvider")
public interface RetailGoodsInfoProvider {
     ...
     */
    @PostMapping("/goods/${application.goods.version}/info/retail/modify")
     ...
     */
    @PostMapping("/goods/${application.goods.version}/info/retail-modify-price")
     ...
     */
    @PostMapping("/goods/${application.goods.version}/info/fill-retail-goods-status")
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/retail/info/modify-sku-batch-no")
