...
@FeignClient(value = "${application.goods.name}", url="${feign.url.goods:#{null}}", contextId = "RetailGoodsQueryProvider")
public interface RetailGoodsQueryProvider {
    /**
     * 分页查询零售商品信息
     *
     ...
     */
    @PostMapping("/goods/${application.goods.version}/retail-page")
    BaseResponse<GoodsPageResponse> retailpage(@RequestBody @Valid GoodsPageRequest goodsPageRequest);
     ...
     */
    @PostMapping("/goods/${application.goods.version}/get-retail-view-by-id")
    BaseResponse<GoodsViewByIdResponse> getRetailViewById(@RequestBody @Valid GoodsViewByIdRequest goodsByIdRequest);
     ...
     */
    @PostMapping("/goods/${application.goods.version}/get-retail-by-id")
    BaseResponse<GoodsByIdResponse> getRetailById(@RequestBody @Valid GoodsByIdRequest goodsByIdRequest);
     ...
     */
    @PostMapping("/goods/${application.goods.version}/list-retail-by-ids")
    BaseResponse<GoodsListByIdsResponse> listRetailByIds(@RequestBody @Valid GoodsListByIdsRequest request);
     ...
     */
    @PostMapping("/goods/${application.goods.version}/retail-list-by-condition")
    BaseResponse<GoodsByConditionResponse> retailListByCondition(@RequestBody @Valid GoodsByConditionRequest goodsByConditionRequest);
     ...
     * @return 商品信息列表 {@link GoodsListByIdsResponse}
     */
    @PostMapping("/goods/${application.goods.version}/retail-list-by-ids-no-valid")
    BaseResponse<GoodsListByIdsResponse> retailListByGoodsIdsNoValid(@RequestBody @Valid GoodsListByIdsRequest request);
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/retail-count-by-condition")
     ...
     */
    @PostMapping("/goods/${application.goods.version}/retail-ref-by-goods-ids")
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/retail-list-by-providerGoodsIds")
     ...
     * @return
     */
    @PostMapping("/goods/${application.goods.version}/retail/list-by-erp")
