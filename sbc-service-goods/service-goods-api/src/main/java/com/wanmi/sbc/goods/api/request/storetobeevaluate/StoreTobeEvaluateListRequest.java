...
@NoArgsConstructor
@AllArgsConstructor
public class StoreTobeEvaluateListRequest implements Serializable {

	private static final long serialVersionUID = -5943320151334350633L;
	 ...
	 * 批量查询-orderNos
	 */
	@ApiModelProperty(value = "批量查询-orderNos")
