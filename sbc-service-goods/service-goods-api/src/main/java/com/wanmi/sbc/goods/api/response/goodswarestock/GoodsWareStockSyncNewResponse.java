...
import com.wanmi.sbc.goods.bean.vo.GoodsWareStockSimpDTO;
...
@NoArgsConstructor
@AllArgsConstructor
public class GoodsWareStockSyncNewResponse implements Serializable {
    ...
    private List<GoodsWareStockVO> goodsWareStockVOS;
}
