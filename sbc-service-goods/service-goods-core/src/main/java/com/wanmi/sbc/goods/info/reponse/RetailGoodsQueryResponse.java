 ...
 */
@Data
public class RetailGoodsQueryResponse {

    /**
     * 商品分页数据
     */
    private Page<RetailGoods> goodsPage = new PageImpl<>(new ArrayList<>());

    /**
     * 商品SKU全部数据
     */
    private List<RetailGoodsInfo> goodsInfoList = new ArrayList<>();
