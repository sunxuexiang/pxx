package com.wanmi.sbc.goods.devanninggoodsinfo.request;
...
@AllArgsConstructor
@NoArgsConstructor
public class DevanningGoodsInfoQueryRequest extends BaseQueryRequest implements Serializable {


    private static final long serialVersionUID = -350545409333173952L;
     ...
     * @return
     */
    public Specification<DevanningGoodsInfo> getWhereCriteria() {
        return (root, cquery, cbuild) -> {
            ...
            //除数
            if (divisorFlag!=null){
                predicates.add(cbuild.equal(root.get("divisorFlag"),divisorFlag));
            }
            ...
            //父级SKUID
            if(parentGoodsInfoId != null){
                predicates.add(cbuild.equal(root.get("parentGoodsInfoId"), parentGoodsInfoId));
            }
