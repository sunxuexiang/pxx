...
@AllArgsConstructor
@NoArgsConstructor
public class BulkGoodsInfoQueryRequest extends BaseQueryRequest implements Serializable {
     ...
     * @return
     */
    public Specification<BulkGoodsInfo> getWhereCriteria() {
        return (root, cquery, cbuild) -> {
            ...
            if(Objects.nonNull(wareId)){
                predicates.add(root.get("wareId").in(wareId));
            }
            //SPU编号
