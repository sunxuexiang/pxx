package com.wanmi.sbc.goods.devanninggoodsinfo.model.root;
...
@Data
@Entity
@Table(name = "devanning_goods_info")
@NamedEntityGraph(name = "DevanningGoodsInfo.Graph", attributeNodes = {@NamedAttributeNode(value = "goods")})
public class DevanningGoodsInfo implements Serializable {


    private static final long serialVersionUID = -5208659528303311330L;
    /**
     * 包装配置ID
     */
    @Id
     ...
     * 拆箱商品副标题
     */
    @Column(name = "goods_info_subtitle")
