...
@Data
@Entity
@Table(name = "bulk_goods_info")
public class BulkGoodsInfo {
     ...
     * 是否限制起购数量
     */
    @Column(name = "is_start_buy_num")
    private DefaultFlag isStartBuyNum = DefaultFlag.NO;

    /**
     * 起购数量（默认为 0 即：不限制）
     */
    @Column(name = "start_buy_num")
    private Integer startBuyNum = 0;
