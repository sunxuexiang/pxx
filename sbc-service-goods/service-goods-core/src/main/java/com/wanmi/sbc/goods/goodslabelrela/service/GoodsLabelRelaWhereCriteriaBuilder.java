 ...
 */
public class GoodsLabelRelaWhereCriteriaBuilder {
    public static Specification<GoodsLabelRela> build(GoodsLabelRelaQueryRequest queryRequest) {
        return (root, cquery, cbuild) -> {
            ...
            // 标签id
            if (queryRequest.getLabelId() != null) {
                predicates.add(cbuild.equal(root.get("labelId"), queryRequest.getLabelId()));
            }
