 ...
 * @version: 1.0
 */
public class BulkGoodsInfoConvert {

    private BulkGoodsInfoConvert(){

    }

    /**
     * RetailGoodsInfoEditResponse 对象 转换成 GoodsInfoViewByIdResponse 对象
     * @param editResponse
     * @return GoodsInfoViewByIdResponse 对象
     */
    public static GoodsInfoViewByIdResponse toGoodsInfoViewByGoodsInfoEditResponse(BulkGoodsInfoEditResponse editResponse){
        ...
        if (CollectionUtils.isNotEmpty(editResponse.getWareHousesList())){
            response.setWareHousesList(KsBeanUtil.convertList(editResponse.getWareHousesList(), WareHouseVO.class));
        }
        return response;
    }
