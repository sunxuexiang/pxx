 ...
 * @version: 1.0
 */
public class RetailGoodsInfoConvert {

    private RetailGoodsInfoConvert(){
     ...
     */
    public static GoodsInfoViewByIdResponse toGoodsInfoViewByGoodsInfoEditResponse(RetailGoodsInfoEditResponse editResponse){
