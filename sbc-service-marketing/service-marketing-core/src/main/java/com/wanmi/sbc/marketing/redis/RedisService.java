...
public class RedisService {
    ...
    public Long decrKey(String key) {
        return redisTemplate.execute((RedisCallback<Long>) connection ->
                connection.decr(redisTemplate.getStringSerializer().serialize(key))
        );
    }
     ...
     * @return
     */
    public Long decrKey(String key,long num) {
        return redisTemplate.execute((RedisCallback<Long>) connection ->
                connection.decrBy(redisTemplate.getStringSerializer().serialize(key),num)
        );
    }
