...
import com.wanmi.sbc.returnorder.api.provider.shopcart.BulkShopCartQueryProvider;
...
public class BulkShopCartQueryController implements BulkShopCartQueryProvider {
    ...
    @Override
    public BaseResponse<com.wanmi.sbc.returnorder.api.response.purchase.MarketingGroupCardResponse> purchaseInfoCache(PurchaseListRequest request) {
