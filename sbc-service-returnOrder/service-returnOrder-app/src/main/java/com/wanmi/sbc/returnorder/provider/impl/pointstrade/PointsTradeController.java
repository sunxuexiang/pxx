...
import com.wanmi.sbc.returnorder.api.provider.pointstrade.PointsTradeProvider;
...
public class PointsTradeController implements PointsTradeProvider {
    ...
    /**
     * @return com.wanmi.sbc.common.base.BaseResponse<com.wanmi.sbc.returnorder.api.response.trade.TradeDeliverResponse>
     * @Author lvzhenwei
     * @Description 积分订单发货
