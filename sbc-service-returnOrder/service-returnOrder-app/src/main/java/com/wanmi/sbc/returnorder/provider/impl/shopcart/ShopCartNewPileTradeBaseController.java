...
@Validated
@RestController
public class ShopCartNewPileTradeBaseController implements ShopCartNewPileProvider {
    ...
    public BaseResponse save(@RequestBody @Valid PurchaseSaveRequest request) {
        shopCartNewPileTradeService.save(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse newsave(PurchaseSaveRequest request) {
        shopCartNewPileTradeService.saveAndCache(KsBeanUtil.convert(request, ShopCartRequest.class),request.getMarketingid());
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse batchSave(@RequestBody @Valid PurchaseBatchSaveRequest request) {
        shopCartNewPileTradeService.batchSave(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse batchSaveDevanning(@Valid PurchaseBatchSaveRequest request) {
        shopCartNewPileTradeService.devanningMergin(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse batchSaveNewDevanning(PurchaseBatchSaveRequest request) {
          shopCartNewPileTradeService.cacheBatchSaveDevanning(KsBeanUtil.convert(request, ShopCartRequest.class));;
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse updateNum(@RequestBody @Valid PurchaseUpdateNumRequest request) {
        shopCartNewPileTradeService.updateNum(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse updateDevanningNum(@Valid PurchaseUpdateNumRequest request) {
        shopCartNewPileTradeService.devanningNumMergin(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse updateDevanningNumNew(PurchaseUpdateNumRequest request) {
         shopCartNewPileTradeService.updateNumDevanningAndCache(KsBeanUtil.convert(request, ShopCartRequest.class),request.getMarketingid());
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse updateNumList(@Valid PurchaseUpdateNumRequest request) {
        shopCartNewPileTradeService.updateNumByIds(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse delete(@RequestBody @Valid PurchaseDeleteRequest request) {
        shopCartNewPileTradeService.delete(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse devanningDelete(@Valid PurchaseDeleteRequest request) {
        shopCartNewPileTradeService.devanningDelete(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse devanningDeleteCache(PurchaseDeleteRequest request) {
        shopCartNewPileTradeService.devanningDeleteCache(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse addFollow(@RequestBody @Valid PurchaseAddFollowRequest request) {
        shopCartNewPileTradeService.addFollow(KsBeanUtil.convert(request, ShopCartRequest.class));
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse clearLoseGoods(@RequestBody @Valid PurchaseClearLoseGoodsRequest request) {
        shopCartNewPileTradeService.clearLoseGoods(request.getUserId(), request.getDistributeChannel());
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse<PurchaseListResponse> calcAmount(@RequestBody @Valid PurchaseCalcAmountRequest request) {
        PurchaseListResponse purchaseListResponse = shopCartNewPileTradeService.calcAmount(KsBeanUtil.convert(request.getPurchaseCalcAmount(), PurchaseListResponse.class),
    ...
    public BaseResponse<PurchaseCalcMarketingResponse> calcMarketingByMarketingId(@RequestBody @Valid PurchaseCalcMarketingRequest request) {
        PurchaseMarketingCalcResponse purchaseMarketingCalcResponse = shopCartNewPileTradeService.calcMarketingByMarketingIdBase(
    ...
    public BaseResponse<PurchaseCalcMarketingResponse> calcCouponActivityByActivityId(@RequestBody @Valid PurchaseCalcMarketingRequest request) {
        PurchaseMarketingCalcResponse purchaseMarketingCalcResponse = shopCartNewPileTradeService
    ...
    public BaseResponse syncGoodsMarketings(@RequestBody @Valid PurchaseSyncGoodsMarketingsRequest request) {
        shopCartNewPileTradeService.syncGoodsMarketings(request.getGoodsMarketingMap(), request.getCustomerId());
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse modifyGoodsMarketing(@RequestBody @Valid PurchaseModifyGoodsMarketingRequest request) {
        shopCartNewPileTradeService.modifyGoodsMarketing(request.getGoodsInfoId(), request.getMarketingId(), KsBeanUtil.convert(request.getCustomer(), CustomerVO.class));
        return BaseResponse.SUCCESSFUL();
    }
    ...
    public BaseResponse<PurchaseFillBuyCountResponse> fillBuyCount(@RequestBody @Valid PurchaseFillBuyCountRequest request) {
        List<GoodsInfoVO> goodsInfoList = shopCartNewPileTradeService.fillBuyCount(request.getGoodsInfoList(), request.getCustomerId(), request.getInviteeId());
    ...
    public BaseResponse mergePurchase(@RequestBody @Valid PurchaseMergeRequest request) {
        shopCartNewPileTradeService.mergePurchase(request);
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse<PurchaseMarketingResponse> getPurchasesMarketing(@RequestBody @Valid PurchaseMarketingRequest request){
        return BaseResponse.success(shopCartNewPileTradeService.getPurchasesMarketing(request.getGoodsInfoIds(),
    ...
    public BaseResponse getSkuPurchaseNum(@RequestBody @Valid PurchaseQueryDTO request) {
        return BaseResponse.success(shopCartNewPileTradeService.getSkuPurchaseNum(request));
    }

    @Override
    public BaseResponse copySave(PurchaseSaveRequest request) {
        shopCartNewPileTradeService.copySave(request);
        return BaseResponse.SUCCESSFUL();
    }
    @Override
    public BaseResponse copySaveNew(PurchaseSaveRequest request) {
        shopCartNewPileTradeService.copySaveNew(request);
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse delFirstSnapShopAndMarkeing(String request) {
        shopCartNewPileTradeService.delFirstSnapShopAndMarkeing(request);
        return BaseResponse.SUCCESSFUL();
    }

    @Override
    public BaseResponse refreshShopCarRedis() {
         shopCartNewPileTradeService.refreshShopCarRedis();
        return BaseResponse.SUCCESSFUL();
    }
