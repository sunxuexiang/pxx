...
@EnableJpaAuditing
@EnableCaching
public class ServiceReturnOrderAppApplication {

    public static void main(String[] args) throws Exception{

        Environment env = SpringApplication.run(ServiceReturnOrderAppApplication.class, args).getEnvironment();
        String port = env.getProperty("server.port", "9980");
        String healthPort = env.getProperty("management.server.port", "9981");
