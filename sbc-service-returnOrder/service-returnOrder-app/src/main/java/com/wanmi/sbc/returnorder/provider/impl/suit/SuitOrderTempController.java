package com.wanmi.sbc.returnorder.provider.impl.suit;

import com.wanmi.sbc.common.base.BaseResponse;
import com.wanmi.sbc.common.util.KsBeanUtil;
import com.wanmi.sbc.returnorder.api.provider.suit.SuitOrderTempProvider;
...
public class SuitOrderTempController implements SuitOrderTempProvider {
    ...
    public BaseResponse<Integer> getSuitBuyCountByCustomerAndMarketingId(SuitOrderTempQueryRequest request) {
        ...
        Integer count = suitOrderTempService.getSuitBuyCountByCustomerAndMarketingId(KsBeanUtil.convert(request, com.wanmi.sbc.returnorder.suit.request.SuitOrderTempQueryRequest.class));
