package com.wanmi.sbc.returnorder.pointstrade.request;
...
import com.wanmi.sbc.returnorder.bean.dto.TradeStateDTO;
...
public class PointsTradeQueryRequest extends BaseQueryRequest {
    ...
    private List<Criteria> getCommonCriteria() {
        ...
        if (StringUtils.isNoneBlank(id)) {
            criterias.add(com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("id", id));
        }
        ...
        if (StringUtils.isNotBlank(supplierCode)) {
            criterias.add(com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("supplier.supplierCode", supplierCode));
        }

        if (StringUtils.isNotBlank(supplierName)) {
            criterias.add(com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("supplier.supplierName", supplierName));
        }

        // 客户名称-模糊查询
        if (StringUtils.isNotBlank(buyerName)) {
            criterias.add(com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("buyer.name", buyerName));
        }

        // 客户账号-模糊查询
        if (StringUtils.isNotBlank(buyerAccount)) {
            criterias.add(com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("buyer.account", buyerAccount));
        }

        // 收货人
        if (StringUtils.isNotBlank(consigneeName)) {
            criterias.add(com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("consignee.name", consigneeName));
        }

        // 收货电话
        if (StringUtils.isNotBlank(consigneePhone)) {
            criterias.add(com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("consignee.phone", consigneePhone));
        }
        ...
        if (StringUtils.isNotBlank(skuName)) {
            ...
            orCriteria.orOperator(
                    com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("tradeItems.skuName", skuName),
                    com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("gifts.skuName", skuName));
        ...
        if (StringUtils.isNotBlank(skuNo)) {
            Criteria orCriteria = new Criteria();
            orCriteria.orOperator(
                    com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("tradeItems.skuNo", skuNo),
                    com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("gifts.skuNo", skuNo));
            criterias.add(orCriteria);
        }
        ...
        if (StringUtils.isNotBlank(keyworks)) {
            Criteria orCriteria = new Criteria();
            orCriteria.orOperator(
                    com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("id", keyworks),
                    com.wanmi.sbc.returnorder.bean.util.XssUtils.regex("tradeItems.skuName", keyworks),
