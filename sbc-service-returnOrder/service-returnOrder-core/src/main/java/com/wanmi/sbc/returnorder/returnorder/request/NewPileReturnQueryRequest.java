package com.wanmi.sbc.returnorder.returnorder.request;
...
@Data
public class NewPileReturnQueryRequest extends BaseQueryRequest {
    ...
    public Criteria build() {
        ...
        if (Objects.nonNull(payType)) {
            criteria.add(Criteria.where("payType").is(payType.toString()));
        }
