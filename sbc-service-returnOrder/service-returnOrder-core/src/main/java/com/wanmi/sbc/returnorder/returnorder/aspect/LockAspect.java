package com.wanmi.sbc.returnorder.returnorder.aspect;
...
public class LockAspect {
    ...
    @Pointcut("execution(* com.wanmi.sbc.returnorder.returnorder.fsm.ReturnFSMService.*(..))" +
            " && @annotation(com.wanmi.sbc.returnorder.returnorder.aspect.LockUnlock)")
