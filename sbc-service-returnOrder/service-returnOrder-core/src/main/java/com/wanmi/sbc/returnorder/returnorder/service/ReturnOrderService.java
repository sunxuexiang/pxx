...
import com.wanmi.sbc.returnorder.api.request.trade.AddWalletRecordRequest;
...
import com.wanmi.sbc.returnorder.returnorder.model.entity.AuditOrderEntry;
import com.wanmi.sbc.returnorder.returnorder.model.entity.KingdeeAuditOrder;
...
import com.wanmi.sbc.returnorder.returnorder.model.value.*;
import com.wanmi.sbc.returnorder.returnorder.mq.ReturnOrderProducerService;
import com.wanmi.sbc.returnorder.returnorder.repository.*;
...
//                        verifyService.subSkuListStock(trade.getGifts(), trade.getDeliverWay().equals(DeliverWay.PICK_SELF) ? trade.getTradeWareHouse().getWareId() : trade.getWareId(),trade.getSaleType());
        ...
        //添加退货单余额信息
        fillReturnBalancePriceAndCashPrice(returnOrder, trade);
        //保存退单
        returnOrderService.addReturnOrder(returnOrder);
...
//        insertES(returnOrder);
    ...
    */
     ...
     * @param trade
     */
    private void fillReturnBalancePriceAndCashPrice(ReturnOrder returnOrder, Trade trade) {
...
//                //先下支付
            ...
            if (Objects.nonNull(deliveryPrice) && deliveryPrice.compareTo(BigDecimal.ZERO) > 0) {
                Trade trade = tradeService.detail(returnOrder.getTid());
                if (Objects.nonNull(trade) && Objects.equals(trade.getDeliverWay(), DeliverWay.DELIVERY_TO_STORE)) {
