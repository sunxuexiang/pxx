package com.wanmi.sbc.returnorder.historytownshiporder.service;
...
public class HistoryTownShipOrderService {
    ...
    public void reduceTownStock(String tid){
        ...
        if (CollectionUtils.isEmpty(historyTownShipOrderRepository.getOrderBytid(tid))){
            log.info("com.wanmi.sbc.returnorder.historytownshiporder.service.HistoryTownShipOrderService.reduceTownStock=================未查询到数据或者已经推送wms，tid="+tid);
        }else {
