...
import com.wanmi.sbc.returnorder.trade.pilefsm.action.GrouponActionPile;
...
@Component
public class GrouponPileBuilder implements PileBuilder {
    ...
    @Autowired
    private GrouponActionPile grouponAction;
