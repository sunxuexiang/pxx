 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnOrderInvoiceProvider")
public interface OrderInvoiceProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/invoice/generate-order-invoice")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/invoice/modify")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/invoice/modify-OrderInvoiceState")
     ...
     * @return  操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/invoice/invalid")
     ...
     * @return  操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/invoice/delete")
     ...
     * @return  操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/invoice/delete-by-orderNo")
