 ...
 * @return
 **/
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnPointsTradeQueryProvider")
public interface PointsTradeQueryProvider {
     ...
     */
    @PostMapping("/points/returnOrder/${application.order.version}/points-trade/get-by-id")
     ...
     * @return
     */
    @PostMapping("/points/returnOrder/${application.order.version}/points-trade/page-criteria")
     ...
     */
    @PostMapping("/points/returnOrder/${application.order.version}/points-trade/list-points-trade-export")
     ...
     * @return
     */
    @PostMapping("/points/returnOrder/${application.order.version}/trade/order-auto-receive")
