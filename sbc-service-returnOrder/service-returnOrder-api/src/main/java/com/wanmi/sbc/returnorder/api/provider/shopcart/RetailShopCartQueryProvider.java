 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnRetailShopCartQueryProvider")
public interface RetailShopCartQueryProvider {

    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/update-check-staues")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/mini-list")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/list")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/query")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-store-coupon-exist")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-store-marketing")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/query-goods-marketing-list")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-goods-marketing")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/count-goods")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/mini-list-front")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/list-front")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/validate-and-set-goods-marketings")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/distribution")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/purchase-info")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/purchase-cache-info")
    BaseResponse<MarketingGroupCardResponse> purchaseInfoAndCache(@RequestBody @Valid PurchaseListRequest request);


    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/check-purchas-num")
    ...
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/purchase-info-new")
    BaseResponse<PurchaseListResponse> newPurchaseInfo(@RequestBody @Valid PurchaseListNewRequest request);

    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-store-markeings")
    ...
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-order-markeings")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/query-procurement-config")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/query-my-pile-purchase-list")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/pile-query")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/pile-query-by-customerId-and-skuId")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-pile-count-num-by-customerId")
     ...
     * @return {@link PurchaseCountGoodsResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/and/purchase/count-goods")
     ...
     * @return {@link PurchaseGetGoodsMarketingResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/query/suit-goods-by-purchase")
