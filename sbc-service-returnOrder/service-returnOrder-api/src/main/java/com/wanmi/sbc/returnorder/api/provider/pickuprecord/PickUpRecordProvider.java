...
import com.wanmi.sbc.returnorder.api.response.pickuprecord.PickUpRecordAddResponse;
import com.wanmi.sbc.returnorder.api.response.pickuprecord.PickUpRecordModifyResponse;
 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnPickUpRecordProvider")
public interface PickUpRecordProvider {
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/pickuprecord/add")
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/pickuprecord/modify")
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/pickuprecord/updatePickUp")
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/pickuprecord/delete-by-id")
	 ...
	 * @return 删除结果 {@link BaseResponse}
	 */
	@PostMapping("/returnOrder/${application.order.version}/pickuprecord/delete-by-id-list")
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/pickuprecord/add-batch")
