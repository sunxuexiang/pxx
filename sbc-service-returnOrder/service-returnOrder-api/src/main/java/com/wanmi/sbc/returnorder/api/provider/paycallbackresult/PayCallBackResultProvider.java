...
import com.wanmi.sbc.returnorder.api.request.paycallbackresult.PayCallBackResultAddRequest;
import com.wanmi.sbc.returnorder.api.request.paycallbackresult.PayCallBackResultDelByIdRequest;
import com.wanmi.sbc.returnorder.api.request.paycallbackresult.PayCallBackResultModifyRequest;
import com.wanmi.sbc.returnorder.api.request.paycallbackresult.PayCallBackResultModifyResultStatusRequest;
import com.wanmi.sbc.returnorder.api.response.paycallbackresult.PayCallBackResultAddResponse;
import com.wanmi.sbc.returnorder.api.response.paycallbackresult.PayCallBackResultModifyResponse;
 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnPayCallBackResultProvider")
public interface PayCallBackResultProvider {
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/paycallbackresult/add")
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/paycallbackresult/modify")
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/paycallbackresult/delete-by-id")
	 ...
	 */
	@PostMapping("/returnOrder/${application.order.version}/paycallbackresult/modify_result_status_by_businessId")
