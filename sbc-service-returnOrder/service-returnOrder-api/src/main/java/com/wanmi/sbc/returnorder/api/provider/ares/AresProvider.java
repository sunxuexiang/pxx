package com.wanmi.sbc.returnorder.api.provider.ares;

import com.wanmi.sbc.common.base.BaseResponse;
import com.wanmi.sbc.returnorder.api.request.areas.*;
 ...
 * Date: 2018-12-5
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnAresProvider")
public interface AresProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/add-order")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/add-orderList")
     ...
     * @return  {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/pay-order")
   BaseResponse  payOrder(@RequestBody @Valid PayOrderRequest request);
     ...
     * @return  {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/offline-payorder")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/pay-orderinit")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/return-order")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/return-orderinit")
     ...
     * @return  {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/init-orderes")
     ...
     * @return  {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/init-returnorderes")
     ...
     * @return  {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/ares/init-payordereS")
