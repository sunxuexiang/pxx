 ...
 * Date: 2018-11-30
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnShopCartProvider")
public interface ShopCartProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/newsave")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/batch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/datch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/new-datch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/update-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/update-devanning-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/update-devanning-numnew")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/delete")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/devanningdelete")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/devanningdeleteCache")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/add-follow")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/clear-lose-goods")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/calc-amount")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/calc-marketing-by-marketing-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/calc-coupon-activity-by-activity-id")
    ...
    @PostMapping("/returnOrder/${application.order.version}/shopcart/calc-coin-activity-by-activity-id")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/sync-goods-marketings")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/modify-goods-marketing")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/fill-buy-count")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/merge-purchase")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/get-purchases-marketing")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/update-num-list")
    BaseResponse updateNumList(@RequestBody @Valid PurchaseUpdateNumRequest request);

    /**
     * 查询sku购物车里的数量
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/get-sku-purchase-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/copy-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/new/copy-save")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcart/del/snapshop-del")
    ...
    @PostMapping("/returnOrder/${application.order.version}/shopcart/refresh/shopcar")
