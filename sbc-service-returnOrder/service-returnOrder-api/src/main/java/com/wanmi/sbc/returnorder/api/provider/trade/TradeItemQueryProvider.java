 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnTradeItemQueryProvider")
public interface TradeItemQueryProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/trade/item/list-by-customer-id")
     ...
     * @return 订单商品快照列表 {@link TradeItemByCustomerIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/trade/item/list-all-by-customer-id")
    BaseResponse<TradeItemByCustomerIdResponse> listAllByCustomerId(@RequestBody @Valid TradeItemByCustomerIdRequest
                                                                         request);

    @PostMapping("/returnOrder/${application.order.version}/trade/item/list-stock-out-storeId")
     ...
     * @return 订单商品快照列表 {@link TradeItemByCustomerIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/trade/item/item_list-by-customer-id")
