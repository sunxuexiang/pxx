...
import com.wanmi.sbc.returnorder.api.request.trade.newpile.FindPickTradeRequest;
import com.wanmi.sbc.returnorder.api.response.payorder.FindPickTradeResponse;
 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnNewPilePickTradeItemQueryProvider")
public interface NewPilePickTradeItemQueryProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPilePickTrade/item/list-by-customer-id")
     ...
     * @return 订单商品快照列表 {@link TradeItemByCustomerIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/newPilePickTrade/item/list-all-by-customer-id")
    BaseResponse<TradeItemByCustomerIdResponse> listAllByCustomerId(@RequestBody @Valid TradeItemByCustomerIdRequest
                                                                            request);

    @PostMapping("/returnOrder/${application.order.version}/newPilePickTrade/item/list-stock-out-storeId")
     ...
     * @return 订单商品快照列表 {@link TradeItemByCustomerIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/newPilePickTrade/item/item_list-by-customer-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPilePickTrade/item/snapshot")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPilePickTrade/list_pick_trades_by_pile_trade_id")
