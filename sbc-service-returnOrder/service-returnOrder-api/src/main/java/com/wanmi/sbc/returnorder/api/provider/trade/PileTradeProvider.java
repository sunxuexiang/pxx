 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnPileTradeProvider")
public interface PileTradeProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/add-withOp")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/add-batch")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/query-delivery")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/add-batch-with-group")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/commit")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/cancel")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/audit")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/newAudit")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/retrial")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/audit-batch")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/remedy-seller-remark")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/deliver")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/confirm-receive")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/return-order")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/voided")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/reverse")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/deliver-record-obsolete")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/save-invoice")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/pay-pecord-obsolete")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/pay-callBack-online")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/pay-callBack-online-batch")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/pay-callBack")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/default-pay")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/default-pay-batch")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/add-receivable")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/confirm-payOrder")
     ...
     * @return 支付单集合 {@link TradeConfirmPayOrderResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/confirm-payOrder-offline")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/update-settlement-status")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/add")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/update-employeeId")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/update-commission-flag")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/update-final-time")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/update-return-order-num")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/fill-employeeId")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/update")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/push-wms-Order")
    BaseResponse pushConfirmOrder(@RequestBody @Valid TradeGetByIdRequest tradeGetByIdRequest);


    @PostMapping("/returnOrder/${application.order.version}/pile/trade/send-pick-up-message")
    BaseResponse sendPickUpMessage(@RequestBody @Valid SendPickUpMessageRequest sendPickUpMessageRequest);

    @PostMapping("/returnOrder/${application.order.version}/pile/trade/updateTradeLogisticsCompany")
    ...
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/check-wms")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/pay-online-call-back")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/pay-pile-order-call-back")
    BaseResponse payPileOrderCallBack(@RequestBody @Valid TradePayOnlineCallBackRequest tradePayOnlineCallBackRequest);

    @PostMapping("/returnOrder/${application.order.version}/pile/trade/pay-online-recharge-call-back")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/push-order-to-wms")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/add-merge-pay")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/sync-pile-order-price")
    BaseResponse syncPileOrderPrice();
    /**
     * 清洗囤货历史数据
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/writing-historical-data")
    BaseResponse writingHistoricalData();

    /**
     * 余额支付回调
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/wallet-pay")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/count-pile-purchase-action")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/page-pile-purchase-action")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/batch-save-pile-purchase-action")
