 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnPileTradeQueryProvider")
...
//     * @return
//     */
//    @PostMapping("/returnOrder/${application.order.version}/pile/trade/page")
//    BaseResponse<TradePageResponse> page(@RequestBody @Valid TradePageRequest tradePageRequest);
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/page-criteria")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/supplier-page-criteria")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/page-boss-criteria")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/count-criteria")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/wrapper-backend-commit")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-freight")
     ...
     * @return 店铺运费信息 {@link TradeGetFreightResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-boss-freight")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-goods")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/delivery-check")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-by-id")
    BaseResponse<TradeGetByIdResponse> getById(@RequestBody @Valid TradeGetByIdRequest tradeGetByIdRequest);

    /**
     * 管理后台交易订单信息查询
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/getByIdManager")
     ...
     * @return 交易单信息 {@link TradeGetByIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-by-parent")
     ...
     * @return 交易单信息 {@link TradeGetByIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-order-by-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-list-by-parent-id")
     ...
     * @return 交易单信息 {@link TradeListByParentIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-order-list-by-parent-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/verify-after-processing")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/list-all")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-payOrder-by-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/page-for-settlement")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/query-purchaseInfo")
...
//     */
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/query-first-complete-trade")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/send-email-to-finance")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/send-email-translate")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/list-export")
     ...
     * @return 验证结果 {@link TradeListExportResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/list-trade-expor-montht")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-order-list-by-pay-order-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/query-all-comfirm-failed")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-order-list-by-logisticscompany-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-order-list-by-customer-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/query-Purchase-Count")
    BaseResponse<Long> queryPurchaseCount(@RequestBody @Valid PurchaseQueryCountRequest request);

    /**
     * 近30天销量排行
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/query-salesRanking")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-order-time-by-customer-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-goods-pile-num")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/get-goods-pile-num-by-skuIds")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/getPilePurchaseByCustomerId")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/getPileTradesByDate")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/getPileAndTradesPriceByDate")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/trade/recentSevenDaySaleStatistic")
