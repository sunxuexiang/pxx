 ...
 * Date: 2018-12-5
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnPayOrderQueryProvider")
public interface PayOrderQueryProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payorder-bypayorderids")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payorder-bypayordercode")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payorder")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payorderno")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-pile-payorder")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payorder-list")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payorders")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payorders-withnopage")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/find-payordernos")
     ...
     * @return   {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/payorder/sum-payorderprice")
