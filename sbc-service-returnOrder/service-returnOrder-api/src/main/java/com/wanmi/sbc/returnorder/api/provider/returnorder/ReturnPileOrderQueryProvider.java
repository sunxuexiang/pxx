 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnReturnPileOrderQueryProvider")
public interface ReturnPileOrderQueryProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/get-transfer-by-user-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/count-by-condition")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/page")
     ...
     * @return 退单分页列表 {@link ReturnOrderPageResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/newPage")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/list-by-condition")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/get-by-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/list-return-way")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/list-return-reason")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/query-refund-price")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/query-can-return-item-num-by-tid")
     ...
     * @return 含可退商品的交易信息 {@link CanReturnItemNumByTidResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/query-filter-can-return-items-by-tid")
     ...
     * @return 含可退商品的交易信息 {@link CanReturnItemNumByTidResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/query-can-return-num")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/query-can-return-item-num-by-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/list-not-void-by-tid")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/list-by-tid")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/count-by-end-date")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/pile/return/list-by-end-date")
