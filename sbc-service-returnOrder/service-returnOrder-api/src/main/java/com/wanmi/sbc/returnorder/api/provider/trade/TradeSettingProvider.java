...
import com.wanmi.sbc.returnorder.api.request.trade.ReturnOrderModifyAutoAuditRequest;
import com.wanmi.sbc.returnorder.api.request.trade.ReturnOrderModifyAutoReceiveRequest;
import com.wanmi.sbc.returnorder.api.request.trade.TradeSettingModifyRequest;
 ...
 * @version: 1.0
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnTradeSettingProvider")
public interface TradeSettingProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/trade/modify-trade-configs")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/trade/modify-return-order-auto-audit")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/trade/modify-return-order-auto-receive")
     ...
     * @return
    */
    @PostMapping("/returnOrder/${application.order.version}/trade/order-auto-receive")
