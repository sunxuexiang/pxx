 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnRetailShopCartProvider")
public interface RetailShopCartProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/saveWithCache")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/batch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/batch-save-and-cache")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/update-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/update-num-with-cache")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/delete")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/delete-with-cache")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/add-follow")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/clear-lose-goods")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/calc-amount")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/calc-marketing-by-marketing-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/calc-coupon-activity-by-activity-id")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/sync-goods-marketings")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/modify-goods-marketing")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/fill-buy-count")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/merge-purchase")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-purchases-marketing")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/update-num-list")
    BaseResponse updateNumList(@RequestBody @Valid PurchaseUpdateNumRequest request);

    /**
     * 查询sku购物车里的数量
     */
    @PostMapping("/returnOrder/${application.order.version}/retail/shopcart/get-sku-purchase-num")
