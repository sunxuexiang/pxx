 ...
 * Date: 2018-11-30
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnShopCartNewPileProvider")
public interface ShopCartNewPileProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/newsave")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/batch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/datch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/new-datch-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/update-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/update-devanning-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/update-devanning-numnew")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/delete")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/devanningdelete")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/devanningdeleteCache")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/add-follow")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/clear-lose-goods")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/calc-amount")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/calc-marketing-by-marketing-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/calc-coupon-activity-by-activity-id")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/sync-goods-marketings")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/modify-goods-marketing")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/fill-buy-count")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/merge-purchase")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/get-purchases-marketing")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/update-num-list")
    BaseResponse updateNumList(@RequestBody @Valid PurchaseUpdateNumRequest request);

    /**
     * 查询sku购物车里的数量
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/get-sku-purchase-num")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/copy-save")
     ...
     * @return {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/new/copy-save")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/del/snapshop-del")
    ...
    @PostMapping("/returnOrder/${application.order.version}/shopcartnewpilequre/refresh/shopcar")
