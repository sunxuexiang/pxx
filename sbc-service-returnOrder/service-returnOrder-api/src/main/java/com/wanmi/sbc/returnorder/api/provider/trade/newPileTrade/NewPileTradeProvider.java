 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnNewPileTradeProvider")
public interface NewPileTradeProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/get-by-parent")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/commit-all")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/cancel")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPilePickTrade/commit-all")
     ...
     * @return 交易单信息 {@link TradeGetByIdResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/get-by-id")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/query-purchaseInfo")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/get-goods")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/supplier-page-criteria")
     ...
     * 管理后台交易订单信息查询
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/getByIdManager")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/add-receivable")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/page-criteria")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/get-order-list-by-parent-id")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/get-new-pile-goods-num-customer")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/get-new-pile-trade-wareHose-customer")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/update")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/audit")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/audit-batch")
    BaseResponse auditBatch(@RequestBody @Valid TradeAuditBatchRequest tradeAuditBatchRequest);

    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/listByPileNos")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/listTradeExport")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/getOrderListByParentIds")
    ...
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/findByNewPileTradeNos")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/newPileOldDataHandler")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/updateOldDataMongoAndPayOrder")
    BaseResponse updateOldDataMongoAndPayOrder(@RequestBody @Valid String tid);

    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/returnCoupon")
    BaseResponse returnCoupon(@RequestParam(value = "tid") String tid, @RequestParam(value = "rid") String rid);

    @PostMapping("/returnOrder/${application.order.version}/handlePileData")
    BaseResponse<String> handleNanChangPileData(@RequestBody @Valid Map<String, String> map);

    @PostMapping("/returnOrder/${application.order.version}/handleNanChangTakeData")
     ...
     *
     */
    @PostMapping("/returnOrder/${application.order.version}/newPileTrade/getListByParentId")
