...
import com.wanmi.sbc.returnorder.api.request.refund.RefundOrderNotAuditProducerRequest;
 ...
 */
@FeignClient(value = "${application.returnOrder.name}", url="${feign.url.returnOrder:#{null}}", contextId = "ReturnReturnOrderProvider")
public interface ReturnOrderProvider {
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/return/refundOrderNotAuditProducer")
     ...
     * @return 退单id {@link ReturnOrderAddResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/refundOrderNotAuditNewPileProducer")
     ...
     * @return 退单id {@link ReturnOrderAddResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/add")
     ...
     */
    @PostMapping("/returnOrder/${application.order.version}/return/add-transfer")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/delete-transfer")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/audit")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/deliver")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/receive")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/reject-receive")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/online-modify-price")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/online-modify-price-new-pile")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/online-refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/offline-refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/offline-refund-for-supplier")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/offline-refund-for-boss")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/reject-refund")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/reject-refund-refuse")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/cancel")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/reverse")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/remedy")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/modify-employee-id")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/fill-employee-id")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/modify")
     ...
     * @return 操作结果 {@link BaseResponse}
     */
    @PostMapping("/returnOrder/${application.order.version}/return/close-refund")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/return/refund-online-by-tid")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/return/refund-online-by-tid-new-pile")
     ...
     * @return
     */
    @PostMapping("/returnOrder/${application.order.version}/return/free-pile-goods-num")
    BaseResponse freePileGoodsNum(@RequestBody @Valid CanReturnItemNumByIdRequest request);

    @PostMapping("/returnOrder/${application.order.version}/return/updateReturnFlowState")
    BaseResponse updateReturnFlowState(@RequestBody @Valid UpdateReturnFlowStateRequest request);

    @PostMapping("/returnOrder/${application.order.version}/return/returnCoupon")
    BaseResponse returnCoupon(@RequestParam("rid") String rid);

    @GetMapping("/returnOrder/${application.order.version}/return/findByTid")
    BaseResponse<List<ReturnOrderVO>> findByTid(@RequestParam("tid") String tid);

    @GetMapping("/returnOrder/${application.order.version}/return/supplierAutoRefund")
