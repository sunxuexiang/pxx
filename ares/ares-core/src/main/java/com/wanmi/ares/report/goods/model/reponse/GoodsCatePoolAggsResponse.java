 ...
 */
@Data
public class GoodsCatePoolAggsResponse implements Serializable{
     ...
     * @return
     */
//    private GoodsCatePoolAggsResponse addAggResults(SearchResponse response) {
...
//     * @return
//     */
//    public static GoodsCatePoolAggsResponse build(SearchResponse searchResponse) {
//        return new GoodsCatePoolAggsResponse().addAggResults(searchResponse);
//    }
//
//    /**
//     * 全局分类分组块
...
//                //按商品所属分类分组
//                .subAggregation(AggregationBuilders.terms("cate_group").field("skus.cateIds").size(0)
//                        //按类型分组,如下单/付款/退单
...
//                )
//                //按商品当前分类分组
//                .subAggregation(AggregationBuilders.terms("leaf_cate_group").field("skus.leafCateId").size(0));
//    }
//
//    /**
//     * 转换 聚合结果
...
//     * @return
//     */
//    private GoodsCatePoolAggsResponse addAggResultsByComp(SearchResponse response) {
//        if (Objects.nonNull(response.getAggregations())) {
//            this.goodsCateReportList = new ArrayList<>();
//            this.leafCates = new HashSet<>();
...
//     * @return
//     */
//    public static GoodsCatePoolAggsResponse buildByComp(SearchResponse searchResponse) {
//        return new GoodsCatePoolAggsResponse().addAggResultsByComp(searchResponse);
//    }
//
//    /**
//     * 全局分类分组块
