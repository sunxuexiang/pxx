package com.wanmi.sbc.wallet.configuration.support;
...
public class GlobalValidator implements Validator {
    ...
    public boolean supports(Class<?> clazz) {
        return BalanceBaseRequest.class.isAssignableFrom(clazz);
    }

    @Override
    public void validate(Object target, Errors errors) {
        BalanceBaseRequest request = (BalanceBaseRequest) target;
        if (errors.hasErrors()) {
            return;
        }
