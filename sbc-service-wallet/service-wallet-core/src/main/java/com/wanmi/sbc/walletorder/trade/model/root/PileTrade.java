...
import com.wanmi.sbc.walletorder.bean.enums.BookingType;
import com.wanmi.sbc.walletorder.bean.enums.EvaluateStatus;
import com.wanmi.sbc.walletorder.bean.enums.OrderSource;
import com.wanmi.sbc.walletorder.bean.enums.PaymentOrder;
...
@AllArgsConstructor
@NoArgsConstructor
@Document(collection = "pileTrade")
public class PileTrade implements Serializable {
