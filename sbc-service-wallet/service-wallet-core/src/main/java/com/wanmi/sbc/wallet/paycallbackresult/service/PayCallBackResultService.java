...
import com.wanmi.sbc.wallet.bean.constant.ConstantContent;
...
import com.wanmi.sbc.wallet.paycallbackresult.repository.PayCallBackResultRepository;
import com.wanmi.sbc.walletorder.bean.enums.PayWalletCallBackResultStatus;
import com.wanmi.sbc.walletorder.bean.vo.PayCallBackResultVO;
...
public class PayCallBackResultService {
	 ...
	 * @author lvzhenwei
	 */
	public Page<PayCallBackResult> page(PayWalletCallBackResultQueryRequest queryReq){
	 ...
	 * @author lvzhenwei
	 */
	public List<PayCallBackResult> list(PayWalletCallBackResultQueryRequest queryReq){
	 ...
	 */
	@Transactional
	public int updateStatus(String businessId, PayWalletCallBackResultStatus resultStatus){
		if(resultStatus==PayWalletCallBackResultStatus.FAILED){
