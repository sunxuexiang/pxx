...
public enum WalletDetailsType {
    ...
    @ApiEnumProperty("4：取消申请")
    INCREASE_WITHDRAW_CANCEL("取消申请"),

    //5、申请失败 （客服、财务审核未通过或财务操作提现失败）
    @ApiEnumProperty("5：申请失败")
    INCREASE_WITHDRAW_FAIL("申请失败"),
    ...
    DEDUCTION_WITHDRAW_SUCCEED("申请成功"),
    @ApiEnumProperty("6:商品购买")
    DEDUCTION_WITHDRAW_BUY("商品购买"),

    @ApiEnumProperty("9: 提现审核")
    WITHDRAWAL_REVIEW("提现审核"),
    @ApiEnumProperty("10: 鲸币赠送")
    GIVE_JINGBI("鲸币赠送"),
    @ApiEnumProperty("11: 鲸币收回")
    BACK_JINGBI("鲸币收回"),
    @ApiEnumProperty("12: 鲸币充值(平台充)")
    PLATO_GO("鲸币充值(平台充)"),
    @ApiEnumProperty(("13: 鲸币充值(商家充)"))
    STORE_GO("鲸币充值(商家充)")
    ;
