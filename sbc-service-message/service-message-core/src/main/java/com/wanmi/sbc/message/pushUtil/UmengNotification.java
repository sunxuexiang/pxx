...
public abstract class UmengNotification {
	...
	public void setChannelActivity(String channelActivity) throws Exception {
		setPredefinedKeyValue("channel_activity", channelActivity);
	}

	public void setXiaomiChannelId(String xiaomiChannelId) throws Exception {
		setPredefinedKeyValue("xiaomi_channel_id", xiaomiChannelId);
	}

	public void setOppoChannelId(String oppoChannelId) throws Exception {
		setPredefinedKeyValue("oppo_channel_id", oppoChannelId);
	}
